...
export default function Create({ members, subjects, topics, jobTypes }) {
    ...
    const syncFormFields = (payload) => {
        form.setFieldsValue({
            ...
            date_from: payload.date_from ? dayjs(payload.date_from) : null,
            date_to: payload.date_to ? dayjs(payload.date_to) : null,
            extended_date: payload.extended_date ? dayjs(payload.extended_date) : null,
            status: payload.status,
            study_goal_status: payload.study_goal_status,
        });
    };
    ...
    const handleSubmit = async () => {
        try {
            ...
            post(route("administrative.study-goal.store"), {
                preserveScroll: true,
    ...
    return (
        <div>
            ...
            <Drawer
                closable
                destroyOnClose
                title={<p>{t("studyGoal.createTitle")}</p>}
                placement="right"
                open={open}
                loading={loading}
                size="large"
